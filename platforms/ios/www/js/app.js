...
},{"../io/createFileWithContents":25,"../io/doesFileExist":26,"../io/downloadExternalFile":27,"../io/getFile":29,"../io/getFileContents":30,"../io/getFileList":32,"../io/removeFile":37,"../io/writeFile":38,"../util/notify":42,"./config":8,"./config-menu":6,"./xmlToJson":21}],2:[function(require,module,exports){
module.exports = {
    track: true
    , trackId: 'UA-31877-29'
};
...
},{"./ui/getKeyForLanguageOrLocalCenter":11,"./ui/getLocalizedString":12,"./ui/localizedStrings":15}],6:[function(require,module,exports){
...
(function init() {
	...
	$('a.menu-link.feed').on('click', function (e) {
		...
		e.preventDefault();
		if (navigator.connection.type !== Connection.NONE || $check.hasClass('checked') || $check.hasClass('required')) {
			loading.show();
...
},{"../../io/doesFileExist":26,"../../io/getFileContents":30,"../../util/date":40,"../../util/notify":42,"../access":1,"../config":8,"../config-menu":6,"./getLocalizedString":12,"./header":13,"./loading":14,"./localizedStrings":15,"./storyList":20}],17:[function(require,module,exports){
...
},{"../../util/connection":39,"../../util/date":40,"../../util/notify":42,"../access":1,"../config":8,"./getLocalizedString":12,"./header":13,"./loading":14,"./localizedStrings":15,"./refresh":17,"./story":19}],21:[function(require,module,exports){
/*global module, require*/
...
},{"./app/access":1,"./app/downloadMissingImage":9,"./app/ui/getLocalizedString":12,"./app/ui/header":13,"./app/ui/localizedStrings":15,"./app/ui/menu":16,"./app/ui/responsive":18,"./app/ui/storyList":20,"./io/createDir":24,"./io/doesFileExist":26,"./io/getFileContents":30,"./util/connection":39,"./util/date":40,"./util/err":41,"./util/notify":42}],24:[function(require,module,exports){
